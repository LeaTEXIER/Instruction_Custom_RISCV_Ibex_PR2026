...
module ibex_id_stage #(
  ...
  output ibex_pkg::res_sel_e        result_sel_ex_o,
  ...
  logic [31:0] imm_cust2_type;
  logic [31:0] imm_cust3_type;
  ...
  if (BranchTargetALU) begin : g_btalu_muxes
    ...
    always_comb begin : bt_immediate_b_mux
      unique case (bt_b_mux_sel)
        ...
        IMM_B_CUST3:	   bt_b_operand_o = imm_cust3_type;
    ...
    always_comb begin : immediate_b_mux
      unique case (imm_b_mux_sel)
        ...
        IMM_B_CUST2:	   imm_b = imm_cust2_type;
        IMM_B_CUST3:	   imm_b = imm_cust3_type;
        default:         imm_b = 32'h4;
      endcase
    end
  ...
  ibex_decoder #(
    ...
    .imm_cust2_type_o(imm_cust2_type),
    .imm_cust3_type_o(imm_cust3_type),
  ...
  assign result_sel_ex_o             = result_sel;
