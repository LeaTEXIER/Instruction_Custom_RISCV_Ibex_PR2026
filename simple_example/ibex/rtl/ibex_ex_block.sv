...
module ibex_ex_block #(
  ...
  // $display("FU_MOD: A=%h B=%h shamt=%0d result=%h",
  //             alu_operator_i, alu_operand_a_i, alu_operand_b_i, result_o);
  ...
  */
  ...
  ibex_alu #(
    ...
    .adder_result_o     (alu_adder_result_ex_r),
  ...
  always_comb begin
    if (custom_inst == 1'b1) begin
      $display("result %h ", fu_result);
    end
  end
  ////////////////
  // Multiplier //
